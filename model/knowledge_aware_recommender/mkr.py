...
class MKR(KnowledgeRecommender):
    ...
    def calculate_rs_loss(self, interaction):
        ...
        ''' 
        # loss
        user_embeddings, item_embeddings,  scores, scores_normalized = self.forward(user_indices=self.user_indices,
                                                 item_indices=self.item_indices,
                                                 head_indices=self.head_indices,
                                                 relation_indices=None,
                                                 tail_indices=None)        
        head_embeddings, tail_embeddings,   scores_kge, rmse = self.forward(user_indices=None,
                                                 item_indices=self.item_indices,
                                                 head_indices=self.head_indices,
        ...
        base_loss_rs = torch.mean(self.sigmoid_BCE(scores, self.labels))#+torch.mean(self.sigmoid_BCE(scores_kge, self.labels))
    ...
    def calculate_kg_loss(self, interaction):
        ...
        scores_kge, rmse = self.forward(user_indices=None,
                                        ...
                                        tail_indices=self.tail_indices)
        '''
        head_embeddings, tail_embeddings,   scores_kge, rmse = self.forward(user_indices=self.user_indices,
                                                 item_indices=self.item_indices,
                                                 head_indices=self.head_indices,
                                                 relation_indices=self.relation_indices,
                                                 tail_indices=self.tail_indices)    
        ...
        # loss
        base_loss_kge = -scores_kge #- scores
